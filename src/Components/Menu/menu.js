...
const Menu = () => {
    ...
    return(
        ...
        <div className='Drinks'>
            ...
            <HotCard itemName={"Mocha"} itemIngredients={"expresso, chocolate, steamed milk"} itemContents={'mocha'}></HotCard>
            <HotCard itemName={"Macchiato"} itemIngredients={"expresso, milk foam"} itemContents={'mocchiato'}></HotCard>
            <HotCard itemName={"Mocha Breve"} itemIngredients={"expresso, chocolate, half & half"} itemContents={'mochaBreve'}></HotCard>
